...
#include <GL/glxext.h>
GLXContext CAPPCtx;
void * CAPPGetExtension( const char * extname ) { return glXGetProcAddressARB((const GLubyte *) extname); }
#endif
...
void CAPPUpdateScreenWithBitmap( unsigned long * data, int w, int h )
{
