#ifndef _CAPP_ANDROID_H
#define _CAPP_ANDROID_H

//This file contains the additional functions that are available on the Android platform.
//In order to build capp for Android, please compile CAPPEGLDriver.c with -DANDROID
...
// CAPPSetup / CAPPSetupFullScreen only controls whether or not the navigation
